...
[task_local]
#签到领现金
2 0 * * * https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_cash.js, tag=签到领现金, enabled=true

================Loon==============
[Script]
cron "2 0 * * *" script-path= https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 0 * * *",wake-system=1,timeout=20,script-path= https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path= https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_cash.js, cronexpr="2 0 * * *", timeout=200, enable=true
 */
const $ = new Env('签到领现金');
