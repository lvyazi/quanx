...
const jsname='互助码提交'
const $ = Env(jsname)
const dd_shareCode1 = $.getdata('T0225KkcRxwe9wKBIx30wKQLcgCjVWnYaS5kRrbA1') ;
const jx_shareCode1 = $.getdata('pdL3bIfIXC9NkE7NXtIeeA==') ;
const zd_shareCode1 = $.getdata('4npkonnsy7xi3cp4cdz3tzwpvtk5npmnbrs65na') ;
const nc_shareCode1 = $.getdata('1cce19ae78854f50b6d5645f735f502a') ;
const mc_shareCode1 = $.getdata('MTE1NDUyMjEwMDAwMDAwNDEzOTMwOTM=') ;
const joy_shareCode1 = $.getdata('QdNXPt1ArSLJ0ZVUL0s7Z6t9zd5YaBeE') ;

const dd_shareCode2 = $.getdata('dongdonggongchang') ;
const jx_shareCode2 = $.getdata('jingxigongchang') ;
const zd_shareCode2 = $.getdata('zhongdoudedou') ;
const nc_shareCode2 = $.getdata('dongdongnongchang') ;
const mc_shareCode2 = $.getdata('jingdongmengcong') ;
const joy_shareCode2 = $.getdata('joy') ;
