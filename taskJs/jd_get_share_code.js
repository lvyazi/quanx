...
[task_local]
#获取互助码
20 13 * * 6 https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_get_share_code.js, tag=获取互助码, enabled=true

================Loon==============
[Script]
cron "20 13 * * 6" script-path=https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_get_share_code.js, tag=获取互助码

===============Surge=================
获取互助码 = type=cron,cronexp="20 13 * * 6",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_get_share_code.js

============小火箭=========
获取互助码 = type=cron,script-path=https://raw.githubusercontent.com/lvyazi/quanx/main/taskJs/jd_get_share_code.js, cronexpr="20 13 * * 6", timeout=200, enable=true
 */
const $ = new Env("获取互助码");
